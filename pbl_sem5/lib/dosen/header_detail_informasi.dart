...
class HeaderDetailInformasi extends StatefulWidget {
  const HeaderDetailInformasi({Key? key}) : super(key: key);

  @override
  _HeaderDetailInformasiState createState() => _HeaderDetailInformasiState();
}

class _HeaderDetailInformasiState extends State<HeaderDetailInformasi> {

...
class ProfilePreviewScreenPimpinan extends StatefulWidget {
  final String username;
  final Map<String, dynamic> profileData;
  final VoidCallback? onProfileUpdated;

  const ProfilePreviewScreenPimpinan({
    super.key,
  ...
  @override
  State<ProfilePreviewScreenPimpinan> createState() => _ProfilePreviewScreenPimpinanState();
}

class _ProfilePreviewScreenPimpinanState extends State<ProfilePreviewScreenPimpinan> {
  ...
  Future<void> _updateProfileAndCredentials() async {
    ...
    try {
      ...
      await _apiService.updateProfile(
        ...
        posisi: widget.profileData['posisi'],
  ...
  bool _validateInputs() {
    ...
    if (_newPasswordController.text.isNotEmpty) {
      if (_currentPasswordController.text.isEmpty) {
        _showErrorMessage('Password lama harus diisi jika ingin mengubah password');
        return false;
      }

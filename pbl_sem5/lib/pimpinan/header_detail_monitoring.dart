...
class HeaderDetailMonitoring extends StatefulWidget {
  const HeaderDetailMonitoring({Key? key}) : super(key: key);

  @override
  _HeaderDetailMonitoringState createState() => _HeaderDetailMonitoringState();
}

class _HeaderDetailMonitoringState extends State<HeaderDetailMonitoring> {

...
class HeaderDetailRiwayat extends StatefulWidget {
  final bool showBackButton; // Tambahkan parameter

  const HeaderDetailRiwayat({Key? key, this.showBackButton = false}) : super(key: key); // Default false

  @override
  _HeaderDetailRiwayatState createState() => _HeaderDetailRiwayatState();
}

class _HeaderDetailRiwayatState extends State<HeaderDetailRiwayat> {

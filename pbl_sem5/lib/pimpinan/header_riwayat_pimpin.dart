...
class HeaderRiwayatPimpin extends StatefulWidget {
  final bool showBackButton; // Tambahkan parameter

  const HeaderRiwayatPimpin({Key? key, this.showBackButton = false}) : super(key: key); // Default false

  @override
  _HeaderRiwayatPimpinState createState() => _HeaderRiwayatPimpinState();
}

class _HeaderRiwayatPimpinState extends State<HeaderRiwayatPimpin> {

...
class HalamanUtamaPimpinan extends StatefulWidget {
  ...
  const HalamanUtamaPimpinan({Key? key, this.selectedIndex = 0}) : super(key: key);
  ...
  Widget _buildStatsSection() {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          _buildStatCard('Pengajuan Sertifikasi', '10'),
          _buildStatCard('Pengajuan Pelatihan', '2'),
        ],
      ),
    );
  }

...
class HalamanDetailInformasiTendik extends StatefulWidget {
  final InformasiDetail informasi;
  final int selectedIndex;
  final Function onNavigateBack;

  const HalamanDetailInformasiTendik({
    Key? key,
  ...
  @override
  _HalamanDetailInformasiTendikState createState() =>
      _HalamanDetailInformasiTendikState();
}

class _HalamanDetailInformasiTendikState
    extends State<HalamanDetailInformasiTendik> {
  bool isLoved = false;

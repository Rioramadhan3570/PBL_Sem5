...
class HalamanDetailInformasi extends StatefulWidget {
  final  informasi;
  final int selectedIndex;
  final Function onNavigateBack;

  const HalamanDetailInformasi({
    Key? key,
  ...
  @override
  _HalamanDetailInformasiTState createState() =>
      _HalamanDetailInformasiTState();
}

class _HalamanDetailInformasiTState
    extends State<HalamanDetailInformasi> {
  bool isLoved = false;

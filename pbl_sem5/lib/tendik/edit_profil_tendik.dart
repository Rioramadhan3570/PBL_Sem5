...
class EditProfilTendik extends StatefulWidget {
  const EditProfilTendik({Key? key}) : super(key: key);

  @override
  State<EditProfilTendik> createState() => _EditProfilTendikState();
}

class _EditProfilTendikState extends State<EditProfilTendik> {
  final TextEditingController _nameController = TextEditingController();
  final TextEditingController _idController = TextEditingController();
  final TextEditingController _phoneController = TextEditingController();

  String _selectedRole = 'Tendik';

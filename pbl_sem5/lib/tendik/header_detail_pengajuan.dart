...
class HeaderDetailPengajuan extends StatefulWidget {
  const HeaderDetailPengajuan({Key? key}) : super(key: key);

  @override
  _HeaderDetailPengajuanState createState() => _HeaderDetailPengajuanState();
}

class _HeaderDetailPengajuanState extends State<HeaderDetailPengajuan> {

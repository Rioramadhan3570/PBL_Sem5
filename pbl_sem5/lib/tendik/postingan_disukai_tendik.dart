...
class PostinganDisukaiTendik extends StatefulWidget {
  final int selectedIndex;
  const PostinganDisukaiTendik({Key? key, this.selectedIndex = 1})
      : super(key: key);

  @override
  _PostinganDisukaiTendikState createState() => _PostinganDisukaiTendikState();
}

class _PostinganDisukaiTendikState extends State<PostinganDisukaiTendik> {

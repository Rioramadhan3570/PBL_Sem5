...
class RiwayatTendik extends StatefulWidget {
  const RiwayatTendik({Key? key}) : super(key: key);

  @override
  _RiwayatTendikState createState() => _RiwayatTendikState();
}

class _RiwayatTendikState extends State<RiwayatTendik> {

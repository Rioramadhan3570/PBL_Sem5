...
class SuratTugasTendik extends StatefulWidget {
  final int selectedIndex;
  const SuratTugasTendik({Key? key, this.selectedIndex = 1})
      : super(key: key);

  @override
  _SuratTugasTendikState createState() => _SuratTugasTendikState();
}

class _SuratTugasTendikState extends State<SuratTugasTendik> {

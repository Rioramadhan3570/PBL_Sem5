...
class HalamanUtamaTendik extends StatefulWidget {
  final int selectedIndex;
  const HalamanUtamaTendik({Key? key, this.selectedIndex = 0}) : super(key: key);

  @override
  _HalamanUtamaTendikState createState() => _HalamanUtamaTendikState();
}

class _HalamanUtamaTendikState extends State<HalamanUtamaTendik> {
  @override
  void initState() {
    super.initState();

...
class HeaderEditProfilDosen extends StatefulWidget {
  final bool showBackButton;
  final VoidCallback? onBackPressed;

  const HeaderEditProfilDosen({
    super.key,
  ...
  @override
  _HeaderEditProfilDosenState createState() => _HeaderEditProfilDosenState();
}

class _HeaderEditProfilDosenState extends State<HeaderEditProfilDosen> {

...
class HeaderMandiriDosen extends StatefulWidget {
  final bool showBackButton;
  final VoidCallback? onBackPressed;

  const HeaderMandiriDosen({
    super.key,
  ...
  @override
  _HeaderMandiriDosenState createState() => _HeaderMandiriDosenState();
}

class _HeaderMandiriDosenState extends State<HeaderMandiriDosen> {

...
class HeaderPelatihanForm extends StatefulWidget {
  final bool showBackButton;
  final VoidCallback? onBackPressed;

  const HeaderPelatihanForm({
    super.key,
  ...
  @override
  _HeaderPelatihanFormState createState() => _HeaderPelatihanFormState();
}

class _HeaderPelatihanFormState extends State<HeaderPelatihanForm> {

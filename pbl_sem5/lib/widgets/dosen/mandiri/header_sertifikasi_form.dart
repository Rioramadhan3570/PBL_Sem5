...
class HeaderSertifikasiForm extends StatefulWidget {
  final bool showBackButton;
  final VoidCallback? onBackPressed;

  const HeaderSertifikasiForm({
    super.key,
  ...
  @override
  _HeaderSertifikasiFormState createState() => _HeaderSertifikasiFormState();
}

class _HeaderSertifikasiFormState extends State<HeaderSertifikasiForm> {

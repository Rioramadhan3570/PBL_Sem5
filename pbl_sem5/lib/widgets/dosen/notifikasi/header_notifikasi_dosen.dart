...
class HeaderNotifikasiDosen extends StatefulWidget {
  final bool showBackButton;
  final VoidCallback? onBackPressed;

  const HeaderNotifikasiDosen({
    super.key,
  ...
  @override
  _HeaderNotifikasiDosenState createState() => _HeaderNotifikasiDosenState();
}

class _HeaderNotifikasiDosenState extends State<HeaderNotifikasiDosen> {

...
class HeaderProfilDosen extends StatefulWidget {
  final bool showBackButton;
  final VoidCallback? onBackPressed;

  const HeaderProfilDosen({
    super.key,
  ...
  @override
  _HeaderProfilDosenState createState() => _HeaderProfilDosenState();
}

class _HeaderProfilDosenState extends State<HeaderProfilDosen> {

...
class HeaderRekomendasiDosen extends StatefulWidget {
  final bool showBackButton;
  final VoidCallback? onBackPressed;

  const HeaderRekomendasiDosen({
    super.key,
  ...
  @override
  _HeaderRekomendasiDosenState createState() => _HeaderRekomendasiDosenState();
}

class _HeaderRekomendasiDosenState extends State<HeaderRekomendasiDosen> {

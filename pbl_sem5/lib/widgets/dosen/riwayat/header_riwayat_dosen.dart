...
class HeaderRiwayatDosen extends StatefulWidget {
  final bool showBackButton;
  final VoidCallback? onBackPressed;

  const HeaderRiwayatDosen({
    super.key,
  ...
  @override
  _HeaderRiwayatDosenState createState() => _HeaderRiwayatDosenState();
}

class _HeaderRiwayatDosenState extends State<HeaderRiwayatDosen> {

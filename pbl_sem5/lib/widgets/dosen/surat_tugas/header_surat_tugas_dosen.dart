...
class HeaderSuratTugasDosen extends StatefulWidget {
  final bool showBackButton;
  final VoidCallback? onBackPressed;

  const HeaderSuratTugasDosen({
    super.key,
  ...
  @override
  _HeaderSuratTugasDosenState createState() => _HeaderSuratTugasDosenState();
}

class _HeaderSuratTugasDosenState extends State<HeaderSuratTugasDosen> {

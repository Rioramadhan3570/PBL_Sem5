...
class HeaderPengajuanPimpinan extends StatefulWidget {
  final bool showBackButton;
  final VoidCallback? onBackPressed;

  const HeaderPengajuanPimpinan({
    super.key,
  ...
  @override
  _HeaderPengajuanPimpinanState createState() => _HeaderPengajuanPimpinanState();
}

class _HeaderPengajuanPimpinanState extends State<HeaderPengajuanPimpinan> {

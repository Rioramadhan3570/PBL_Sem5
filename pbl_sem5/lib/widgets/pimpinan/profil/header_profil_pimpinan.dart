...
class HeaderProfilPimpinan extends StatefulWidget {
  final bool showBackButton; // Tambahkan parameter

  const HeaderProfilPimpinan({super.key, this.showBackButton = false}); // Default false

  @override
  _HeaderProfilPimpinanState createState() => _HeaderProfilPimpinanState();
}

class _HeaderProfilPimpinanState extends State<HeaderProfilPimpinan> {

...
class HeaderSuratTugasPimpinan extends StatefulWidget {
  final bool showBackButton;
  final VoidCallback? onBackPressed;

  const HeaderSuratTugasPimpinan({
    super.key,
  ...
  @override
  _HeaderSuratTugasPimpinanState createState() => _HeaderSuratTugasPimpinanState();
}

class _HeaderSuratTugasPimpinanState extends State<HeaderSuratTugasPimpinan> {
